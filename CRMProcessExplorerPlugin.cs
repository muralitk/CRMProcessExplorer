...
namespace CRMProcessExplorer
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ...
        ExportMetadata("Description", "This plugin will help you can view Background/Real-time Processes & Plug-in Trace Logs by records/by dates. Double clicking the record/column will open relevent CRM forms also double clicking the column (long messages) will open up a pop-up view with full details. You can even export the results in .csv file. View process hierarchy by entity."),
